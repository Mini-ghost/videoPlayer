...
; (function () {
    var vm = new Vue({
        ...
        methods: {
            ...
            // 選單點擊
            videoSelectHandler: function (path) {
                this.pathData = path
            },
            videoPalyHandler: function (e) {
                var target = e.target
                var player = this.dom.player
            ...
            uploadTimeNowHandler: function (currentTime) {
                var time, hh, mm, ss;
            ...
            uploadTimeAllHandler: function (duration) {
                var time, hh, mm, ss;
                duration = ~~duration;
                hh = ~~(duration / 3600);
            ...
            speedHandler: function () {
                var speedArray = this.speedArray, player = this.dom.player;
                switch(this.speed){
                    case speedArray[0]:
            ...
            upLoadProgressHandler: function (e) {
                ...
                var num = (e.offsetX / dom.offsetWidth), scrubTime;
